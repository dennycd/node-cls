...
/**
 ...
 A Class obj is a runtime object storing information about the class type and
 facilitates OO features 
...
var Class = function(type, constructor, def){
	...
	//interface can only extend from anohter interface
	...
	//class can either implement an interface or extend a class
		...
		for(var i in def.implement){
			...
			//TOOD - detection of duplicaiton of methods having the same name and same number of parameters 
...
/**
 Static Method to Check whether a given object is an instance of the given class or an instance of a subclass of the given class
**/
...
/**
 ...
 or is a superclass or superinterface of, the class or interface represented by the  
 specified Class parameter. It returns true if so; otherwise it returns false. 
**/
...
/**
	...
	inherited from superclasses and superinterfaces. Array classes return all the (public) member methods 
	inherited from the Object class. The elements in the array returned are not sorted and are not in any 
	particular order. This method returns an array of length 0 if this Class object represents a class or 
	interface that has no public member methods, or if this Class object represents a primitive type or void.
**/
...
/**
	...
	all interfaces implemented by the class. The order of the interface objects in the array corresponds 
	to the order of the interface names in the implements clause of the declaration of the class represented 
	by this object. For example, given the declaration:
	...
	The order of the interface objects in the array corresponds to the order of the interface names in the extends clause 
